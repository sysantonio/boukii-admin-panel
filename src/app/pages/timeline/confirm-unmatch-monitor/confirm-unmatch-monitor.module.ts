...
import { ConfirmUnmatchMonitorComponent } from './confirm-unmatch-monitor.component';
...
@NgModule({
  ...
  declarations: [ConfirmUnmatchMonitorComponent],
  exports: [ConfirmUnmatchMonitorComponent]
})
export class ConfirmUnmatchMonitorModule {
}
