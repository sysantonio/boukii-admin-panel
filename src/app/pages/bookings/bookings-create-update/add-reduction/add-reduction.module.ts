...
import { AddReductionModalComponent } from './add-reduction.component';
...
@NgModule({
  ...
  declarations: [AddReductionModalComponent],
  exports: [AddReductionModalComponent]
})
export class AddReductionModalModule {
}
