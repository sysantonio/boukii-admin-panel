...
import { RefundBookingModalComponent } from './refund-booking.component';
...
@NgModule({
  ...
  declarations: [RefundBookingModalComponent],
  exports: [RefundBookingModalComponent]
})
export class RefundBookginModalModule {
}
