...
import { ConfirmModalEditBookingComponent } from './confirm-dialog-edit-booking.component';
...
@NgModule({
  ...
  declarations: [ConfirmModalEditBookingComponent],
  exports: [ConfirmModalEditBookingComponent]
})
export class ConfirmModalEditBookingModule {
}
