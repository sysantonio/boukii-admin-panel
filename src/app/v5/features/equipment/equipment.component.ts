...
@Component({
  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        <h1><mat-icon>inventory</mat-icon>Alquiler de Material</h1>
        <p>Gestión de inventario y alquiler de equipos</p>
      </div>
      <div class="coming-soon">
        <mat-icon class="icon">construction</mat-icon>
        <h2>Próximamente</h2>
        <p>🎿 Inventario de esquís • 🥾 Botas y bastones • 📋 Sistema check-in/out</p>
  ...
  styles: [`
    ...
    .page-header h1 mat-icon { font-size: 32px; width: 32px; height: 32px; color: #f59e0b; }
    ...
    .coming-soon .icon { font-size: 64px; width: 64px; height: 64px; color: #f59e0b; margin-bottom: 24px; }
