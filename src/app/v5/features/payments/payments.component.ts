...
@Component({
  ...
  template: `
    <div class="page-container">
      ...
      <div class="coming-soon">
        ...
        <h2>Próximamente</h2>
        <p>💳 Procesamiento de pagos • 📊 Estados financieros • 🔒 Seguridad PCI</p>
  ...
  styles: [`
    ...
    .page-header h1 mat-icon { font-size: 32px; width: 32px; height: 32px; color: #059669; }
    ...
    .coming-soon .icon { font-size: 64px; width: 64px; height: 64px; color: #059669; margin-bottom: 24px; }
