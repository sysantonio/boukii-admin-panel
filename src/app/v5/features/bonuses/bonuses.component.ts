...
@Component({
  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        <h1><mat-icon>card_giftcard</mat-icon>Bonos y Códigos</h1>
        <p>Gestión de bonos, descuentos y códigos promocionales</p>
      </div>
      <div class="coming-soon">
        <mat-icon class="icon">construction</mat-icon>
        <h2>Próximamente</h2>
        <p>🎁 Códigos descuento • 🎫 Bonos multi-uso • 📊 Estadísticas de uso</p>
  ...
  styles: [`
    ...
    .page-header h1 mat-icon { font-size: 32px; width: 32px; height: 32px; color: #ec4899; }
    ...
    .coming-soon .icon { font-size: 64px; width: 64px; height: 64px; color: #ec4899; margin-bottom: 24px; }
